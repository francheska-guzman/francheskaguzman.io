  ...
  render() {
    return (
      <div id='about'>
        ...
        <p className="paragraph">My name is Francheska and I was born and raised in San Juan, Puerto Rico. In 2015, after graduating from college, I moved to New York. I am a passionate web developer, and a member of a crowdsourced software testing community called <a href="https://www.utest.com/profile/francheska-guzman/stats" rel="noopener noreferrer" target="_blank">uTest</a>. Eager to contribute to the society, and grow in the tech field. I am currently open for an entry-level or intern position, so feel free to checkout my <a href="https://francheska-guzman.github.io" rel="noopener noreferrer" target="_blank">resume</a>! </p>
      </div>
    );
  }
}
