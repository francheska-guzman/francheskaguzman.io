  ...
  render() {
    return (
      <div id='about'>
        ...
        <br />
        <p className="paragraph">
        Currently open for opportunities as a junior front-end or back-end web developer, in New York or remotely. Let's do people loves to navigate the web applications even more!
        </p>
      </div>
    );
  }
