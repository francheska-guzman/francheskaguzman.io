...
class Footer extends Component {
  render() {
    return (
      <footer>
        <h6 className="grey">Handmade by <a href="https://github.com/francheska-guzman" target="_black">Francheska Guzman</a>.</h6>
        ...
        <a href="http://utest.com/profile/francheska-guzman" target="_black"><img className="logo" src="./images/logo/utest.png" alt="uTest" /></a>
